...
/*! \file SuspendedObjectIntegrator.cc
    \brief Defines the SuspendedObjectIntegrator class
*/
...
*/
void SuspendedObjectIntegrator::integrateStepOne(unsigned int timestep)
    {
...
*/
void SuspendedObjectIntegrator::integrateStepTwo(unsigned int timestep)
    {
    // profile this step
    if (m_prof)
...
void export_SuspendedObjectIntegrator(pybind11::module& m)
    {
    pybind11::class_<SuspendedObjectIntegrator, std::shared_ptr<SuspendedObjectIntegrator>>(m, "SuspendedObjectIntegrator")
