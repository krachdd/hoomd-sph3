...
*/
template<SmoothingKernelType KT_, StateEquationType SET_>
std::vector<double> SinglePhaseFlowTV<KT_, SET_>::getProvidedTimestepQuantities(uint64_t timestep)
{
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void  SinglePhaseFlowTV<KT_, SET_>::activateShepardRenormalization(unsigned int shepardfreq){
            if (shepardfreq <= 0)
                {
                this->m_exec_conf->msg->error() << "sph.models.SinglePhaseFlowTV: Shepard density reinitialization period has to be a positive real number" << std::endl;
                throw std::runtime_error("Error initializing SinglePhaseFlowTV.");
            }
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::setParams(Scalar mu)
    {
    m_mu   = mu;
    if (m_mu <= 0)
         {
         this->m_exec_conf->msg->error() << "sph.models.SinglePhaseFlowTV: Dynamic viscosity has to be a positive real number" << std::endl;
         throw std::runtime_error("Error initializing SinglePhaseFlowTV.");
         }
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::update_ghost_density_pressure(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Update Ghost density, pressure" << std::endl;
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::update_ghost_density(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Update Ghost density" << std::endl;
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::update_ghost_aux1(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Update Ghost aux1" << std::endl;
...
*/
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::setRcut(unsigned int typ1, unsigned int typ2, Scalar rcut)
    {
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::setRCutPython(pybind11::tuple types, Scalar r_cut)
    {
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::mark_solid_particles_toremove(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Mark solid Particles to remove at timestep " << timestep << std::endl;
 ...
 */
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::compute_particlenumberdensity(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Particle Number Density" << std::endl;
 ...
 */
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::compute_ndensity(uint64_t timestep)
{
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Number Density" << std::endl;
 ...
 */
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::compute_pressure(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Pressure" << std::endl;
...
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::compute_noslip(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::NoSlip NoPenetration" << std::endl;
 ...
 */
template<SmoothingKernelType KT_,StateEquationType SET_>
void SinglePhaseFlowTV<KT_, SET_>::renormalize_density(uint64_t timestep)
    {
    this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Density renormalization" << std::endl;
...
void SinglePhaseFlowTV<KT_, SET_>::forcecomputation(uint64_t timestep)
    ...
    if ( m_density_method == DENSITYSUMMATION )
        this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Forces using SUMMATION approach " << m_density_method << endl;
    else if ( m_density_method == DENSITYCONTINUITY )
        this->m_exec_conf->msg->notice(7) << "Computing SinglePhaseFlowTV::Forces using CONTINUITY approach " << m_density_method << endl;
