...
/*! \file ComputeSuspendedProperties.h
...
class PYBIND11_EXPORT ComputeSuspendedProperties : public Compute
    {
    public:
    //! Constructs the compute
    ComputeSuspendedProperties(std::shared_ptr<SystemDefinition> sysdef, std::shared_ptr<ParticleGroup> group);

    //! Destructor
    virtual ~ComputeSuspendedProperties();
