...
#ifndef __KICK_DRIFT_KICK_TV_H__
#define __KICK_DRIFT_KICK_TV_H__

/*! \file KickDriftKickTV.h
    \brief Declares the KickDriftKickTV class
*/
...
/*! Implements so called Kick Drift Kick integration through the IntegrationMethodTwoStep interface

    \ingroup updaters
*/
class PYBIND11_EXPORT KickDriftKickTV : public SPHIntegrationMethodTwoStep
    {
    public:
    //! Constructs the integration method and associates it with the system
    KickDriftKickTV(std::shared_ptr<SystemDefinition> sysdef, std::shared_ptr<ParticleGroup> group);
