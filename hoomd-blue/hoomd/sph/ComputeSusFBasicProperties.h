...
/*! \file ComputeSusFBasicProperties.h
...
/*! ComputeSPFMechanical properties calculates instantaneous properties and provides them in Python.
   ...
   intermediate copies. Use the enum values in suspensionflow_logger_index to index the array and extract the
...
class PYBIND11_EXPORT ComputeSusFBasicProperties : public Compute
    {
    public:
    //! Constructs the compute
    ComputeSusFBasicProperties(std::shared_ptr<SystemDefinition> sysdef, std::shared_ptr<ParticleGroup> group);

    //! Destructor
    virtual ~ComputeSusFBasicProperties();
    ...
    Scalar getAbsoluteVelocity()
        ...
        return h_properties.data[suspensionflow_logger_index::abs_velocity]/m_group->getNumMembersGlobal();
        }
    ...
    Scalar getSumFluidXVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::sum_fluid_velocity_x];
        }
    ...
    Scalar getSumFluidYVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::sum_fluid_velocity_y];
        }
    ...
    Scalar getSumFluidZVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::sum_fluid_velocity_z];
        }
    ...
    Scalar getMeanFluidDensity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::sum_fluid_density]/m_group->getNumMembersGlobal();
        }
    ...
    Scalar getAngularXVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::angularvel_x];
        }

    Scalar getAngularYVelocity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::angularvel_y];
        }

    Scalar getAngularZVelocity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::angularvel_z];
        }


    Scalar getTranslationalXVelocity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::translationvel_x];
        }

    Scalar getTranslationalYVelocity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[suspensionflow_logger_index::translationvel_y];
        }    

    Scalar getTranslationalZVelocity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
