...
*/
SolidAggregateIntegrator::SolidAggregateIntegrator(std::shared_ptr<SystemDefinition> sysdef,
...
SolidAggregateIntegrator::~SolidAggregateIntegrator()
    {
...
pybind11::object SolidAggregateIntegrator::getLimit()
    {
...
void SolidAggregateIntegrator::setLimit(pybind11::object limit)
    {
    if (limit.is_none())
        {
        m_limit = false;
...
bool SolidAggregateIntegrator::getZeroForce()
    {
    return m_zero_force;
    }

void SolidAggregateIntegrator::setZeroForce(bool zero_force)
    {
...
*/
void SolidAggregateIntegrator::integrateStepOne(uint64_t timestep)
    {
...
*/
void SolidAggregateIntegrator::integrateStepTwo(uint64_t timestep)
    {
...
void export_SolidAggregateIntegrator(pybind11::module& m)
    {
    pybind11::class_<SolidAggregateIntegrator, SPHIntegrationMethodTwoStep, std::shared_ptr<SolidAggregateIntegrator>>(
        m,
        "SolidAggregateIntegrator")
        .def(pybind11::init<std::shared_ptr<SystemDefinition>, std::shared_ptr<ParticleGroup>>())
        .def("getDensityMethod", &SolidAggregateIntegrator::getDensityMethod)
        .def("setDensityMethod", &SolidAggregateIntegrator::setDensityMethod)
        .def_property("limit", &SolidAggregateIntegrator::getLimit, &SolidAggregateIntegrator::setLimit)
        .def_property("zero_force", &SolidAggregateIntegrator::getZeroForce, &SolidAggregateIntegrator::setZeroForce);
    }
