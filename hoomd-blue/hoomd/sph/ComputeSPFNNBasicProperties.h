...
/*! \file ComputeSPFNNBasicProperties.h
...
#ifndef __COMPUTE_SPFNN_BASIC_PROPERTIES_H__
#define __COMPUTE_SPFNN_BASIC_PROPERTIES_H__
...
/*! ComputeSPFMechanical properties calculates instantaneous properties and provides them in Python.
   ...
   intermediate copies. Use the enum values in singlephaseflownn_logger_index to index the array and extract the
...
class PYBIND11_EXPORT ComputeSPFNNBasicProperties : public Compute
    {
    public:
    //! Constructs the compute
    ComputeSPFNNBasicProperties(std::shared_ptr<SystemDefinition> sysdef, std::shared_ptr<ParticleGroup> group);

    //! Destructor
    virtual ~ComputeSPFNNBasicProperties();
    ...
    Scalar getAbsoluteVelocity()
        ...
        return h_properties.data[singlephaseflownn_logger_index::abs_velocity]/m_group->getNumMembersGlobal();
        }
    ...
    Scalar getSumFluidXVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::sum_fluid_velocity_x];
        }
    ...
    Scalar getSumFluidYVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::sum_fluid_velocity_y];
        }
    ...
    Scalar getSumFluidZVelocity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::sum_fluid_velocity_z];
        }
    ...
    Scalar getMeanFluidDensity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::sum_fluid_density]/m_group->getNumMembersGlobal();
        }
    ...
    Scalar getMeanViscosity()
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::mean_viscosity]/m_group->getNumMembersGlobal();
        }

    Scalar getMaxViscosity()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::max_viscosity];
        }

    Scalar getMaxShearrate()
        {
#ifdef ENABLE_MPI
        if (!m_properties_reduced)
            reduceProperties();
        ...
        // return only translational component if the flags are not valid
        ArrayHandle<Scalar> h_properties(m_properties, access_location::host, access_mode::read);
        return h_properties.data[singlephaseflownn_logger_index::max_shearrate];
        }
