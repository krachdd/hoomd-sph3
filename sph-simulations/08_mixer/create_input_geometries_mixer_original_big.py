...
print('Smoothing length:', slength)
...
outerD = innerD + 4 * part_rcut * voxelsize                # m
outerR = 0.5*outerD
...
nx, ny, nz = int(num_length + (4*part_rcut)), int(num_length + (4*part_rcut)), int(num_length + (4*part_rcut))
...
init_filename = f'mixer_original_big_{nx}_{ny}_{nz}_vs_{voxelsize}_init.gsd'
