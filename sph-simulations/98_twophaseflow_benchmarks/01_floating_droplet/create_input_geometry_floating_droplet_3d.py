...
nx, ny, nz = int(num_length + (3*part_rcut)), int(num_length + (3*part_rcut)), int(num_length + (3*part_rcut))
...
init_filename = f'droplet_3d_{nx}_{ny}_{nz}_vs_{voxelsize}_init.gsd'
