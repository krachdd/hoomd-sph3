...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_tube_TV.py 30 poiseuille_flow_30_38_38_vs_0.0003333333333333333_init.gsd 100001 