#!/bin/bash
#SBATCH --job-name=05_100_1000_      # Job name
...
#SBATCH --output=05_100_1000_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 05_100_1000_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=100 --reynolds=1000 --steps=10000 --initgsd="liddrivencavity_108_108_11_vs_0.01_re_1000.0_init.gsd"