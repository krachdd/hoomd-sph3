#!/bin/bash
#SBATCH --job-name=05_60_1_      # Job name
...
#SBATCH --output=05_60_1_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 05_60_1_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=60 --reynolds=1 --steps=100000 --initgsd="liddrivencavity_68_68_11_vs_0.016666666666666666_re_1.0_init.gsd"