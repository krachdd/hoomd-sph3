...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=60 --reynolds=1 --steps=100000 --initgsd="liddrivencavity_68_68_17_vs_0.016666666666666666_re_1.0_init.gsd"