#!/bin/bash
#SBATCH --job-name=05_100_10_      # Job name
...
#SBATCH -e 05_100_10_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=100 --reynolds=10 --steps=50000 --initgsd="liddrivencavity_108_108_11_vs_0.01_re_10.0_init.gsd"