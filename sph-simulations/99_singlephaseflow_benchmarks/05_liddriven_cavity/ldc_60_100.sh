#!/bin/bash
#SBATCH --job-name=05_60_100_      # Job name
...
#SBATCH --output=05_60_100_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 05_60_100_%j.err # File to which STDERR will be written
