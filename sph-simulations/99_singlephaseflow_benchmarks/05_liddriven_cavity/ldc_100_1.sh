...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=100 --reynolds=1 --steps=50000 --initgsd="liddrivencavity_108_108_17_vs_0.01_re_1.0_init.gsd"