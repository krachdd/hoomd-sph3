#!/bin/bash
#SBATCH --job-name=re400_ldc_bm      # Job name
...
#SBATCH --output=re400_ldc_bm_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e re400_ldc_bm_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc.py --resolution=200 --reynolds=400 --steps=500001 --initgsd="liddrivencavity_208_208_17_vs_0.005_re_400.0_init.gsd"
