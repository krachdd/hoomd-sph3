#!/bin/bash
#SBATCH --job-name=05_300_10000_      # Job name
...
#SBATCH --output=05_300_10000_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 05_300_10000_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc_tv.py --resolution=300 --reynolds=10000 --steps=5000 --initgsd="liddrivencavity_308_308_11_vs_0.005_re_10000.0_init.gsd"