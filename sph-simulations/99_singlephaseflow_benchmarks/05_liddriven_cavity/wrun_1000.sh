...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_ldc.py --resolution=200 --reynolds=1000 --steps=500001 --initgsd="liddrivencavity_208_208_17_vs_0.005_re_1000.0_init.gsd"
