...
x, y, z = np.meshgrid(*(np.linspace(-box_Lx / 2 + dx/2, box_Lx / 2 - dx/2, NX, endpoint=False),),
                      *(np.linspace(-box_Ly / 2 + dx/2, box_Ly / 2 - dx/2, NY, endpoint=False),),
                      *(np.linspace(-box_Lz / 2 + dx/2, box_Lz / 2 - dx/2, NZ, endpoint=False),))
