#!/bin/bash
#SBATCH --job-name=ldc_s8      # Job name
...
#SBATCH --output=ldc_s8%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e ldc_s8%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS ./ldc.py 8