#!/bin/bash
#SBATCH --job-name=lp_s5      # Job name
...
#SBATCH --output=lp_s5%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e lp_s5%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS ./lp_sc.py input_lp5.txt 5