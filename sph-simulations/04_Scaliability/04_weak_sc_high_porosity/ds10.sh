#!/bin/bash
#SBATCH --job-name=hp_s10      # Job name
...
#SBATCH --output=hp_s10%j.log     # Path to the standard output and error files relative to the working directory
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS ./hp_sc.py input_lp10.txt 10