#!/bin/bash
#SBATCH --job-name=vc_s9      # Job name
...
#SBATCH --output=vc_s9%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e vc_s9%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS ./vc.py input_vc.txt 9