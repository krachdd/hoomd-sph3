#!/bin/bash
#SBATCH --job-name=2sph2     # Job name
...
#SBATCH --output=2sph2%j.log     # Path to the standard output and error files relative to the working directory
...
# SBATCH -o 2sph2.out # File to which STDOUT will be written
#SBATCH -e 2sph2%j.err # File to which STDERR will be written
...
mpirun -np $SLURM_NTASKS ./run_2spheres_poiseuille.py 50 2spheres_poiseuille_geom_50_58_50_vs_0.0002_init.gsd 100001
