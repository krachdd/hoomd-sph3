...
int pgsd_read_chunk(struct pgsd_handle* handle, void* data, const struct pgsd_index_entry* chunk, unsigned int *offset)
    {
    if (handle == NULL)
        {
        return PGSD_ERROR_INVALID_ARGUMENT;
